...
func _process(delta):
	$"../AnimationTree".set("parameters/assobio/conditions/esta_parado", curupira.estado == "parado")
	...
	$"../AnimationTree".set("parameters/conditions/esta_teletraportando", curupira.estado == "teletransportando")
	$"../AnimationTree".set("parameters/conditions/esta_morto", curupira.esta_morto)
