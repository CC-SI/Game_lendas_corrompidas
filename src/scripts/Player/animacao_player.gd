...
func _process(delta):
	...
	$"../AnimationTree".set("parameters/conditions/esta_movimentando", player.estado_jogador == "padrao")
	...
	$"../AnimationTree".set("parameters/conditions/levou_dano", player.estado_jogador == "dano")
